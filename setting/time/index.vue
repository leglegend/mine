                  ...
                  <div class="time-items">
                    <div class="time-item" v-for="item in times" :key="index">
                      ...
                      <span class="free-close" @click="deleteTime(index)">
                        <img src="https://linkfit-pro.oss-cn-hangzhou.aliyuncs.com/Business/static/del-button.png"/>
                      </span>
                    </div>
                    <div class="add-button" @click="addTime">
                      <span>
                        <img src="https://linkfit-pro.oss-cn-hangzhou.aliyuncs.com/Business/static/add-button.png"/>
                      </span>
                      <span>添加营业时间段</span>
                    </div>
