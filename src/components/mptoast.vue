<template>
  <view class="mptoast" :class="textClass" v-if="show" :style="{background:icon==2||icon==-1?'#78BC6D':''}">
    ...
    <div class="mptoast-again" v-if="icon==2">
      <span @click="tryOutAgain2">再试用7天</span>
    </div>
  </view>
</template>
...
<script type="text/ecmascript-6">
  export default {
    ...
    computed: {
      ...
      title () {
        return this.$toastStore.getters.GET_TOAST_TITLE
      },
      text () {
