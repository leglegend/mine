    ...
    <div class="option-context">
      <span class="option-card" :class="{'option-filter':!card.State}"
        ...
        <div class="card-content"
             :style="{'font-size':card.CardName&&card.CardName.length>5?card.CardName.length<10?(75-card.CardName.length*5+'rpx'):'28rpx':'','line-height':card.CardName&&card.CardName.length>10?'40rpx':''}">
      ...
      <span class="option-state">
        ...
        <img :src="card.State?'/static/sale.png':'/static/nosale.png'"/>
      </span>
